...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/@alexmerced/simple_components/SCNPM.js":[function(require,module,exports) {
//////////////////////////////
...
var _simple_components = require("@alexmerced/simple_components");

(0, _simple_components.simpleComponent)({
  prefix: 'test',
  name: 'test',
  builder: function builder(state, props) {
    return "<h1>".concat(state.hello, "</h1>\n    <h2> ").concat(props.user, " </h2>");
  },
  state: {
    hello: 'hello world'
  }
});
document.querySelectorAll('button').forEach(function (value, index) {
  value.addEventListener('click', function () {
    document.querySelectorAll('test-test')[index].setState({
      hello: "".concat(index)
    });
  });
});
},{"@alexmerced/simple_components":"../node_modules/@alexmerced/simple_components/SCNPM.js"}],"../../../../../../../usr/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../../usr/lib/node_modules/parcel/src/builtins/hmr-runtime.js","app.js"], null)
